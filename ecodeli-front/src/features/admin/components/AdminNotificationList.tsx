...
export const AdminNotificationList = ({ items, onDismiss, onMarkAsRead }: AdminNotificationListProps) => (
  <Stack spacing={2}>
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            <Stack direction="row" spacing={1} flexWrap="wrap" mt={0.5}>
              ...
              {notification.severity && (
                <Chip label={notification.severity === 'error' ? 'Critique' : 'Info'} size="small" color={notification.severity} sx={{ height: 24 }} />
              )}
            </Stack>
          </Box>
        </Stack>
