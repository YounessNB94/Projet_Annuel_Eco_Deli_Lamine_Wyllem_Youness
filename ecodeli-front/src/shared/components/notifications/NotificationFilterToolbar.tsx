...
import type { NotificationFilterOption } from '../../types/notifications';

interface NotificationFilterToolbarProps<T extends string> {
...
export const NotificationFilterToolbar = <T extends string>({
  filters,
  value,
  onChange,
  searchTerm,
  ...
  extraFilters,
  searchInputProps,
}: NotificationFilterToolbarProps<T>) => (
  <Stack
    spacing={2}
